fun! PaperColor_tonger#register()
  let g:PaperColor_tonger = {
        \   'maintainer'  : 'cuiyoupeng <cyphbt@gmail.com>',
        \   'source' : 'http://github.com/cypj/tonger-color',
        \   'description' : 'Love Tonger',
        \   'options' : {
        \       'allow_bold': 1
        \    }
        \ }

  let g:PaperColor_tonger.dark = {
        \ 'palette': {
        \     'color00': ['#112a2a', '234'],
        \       'color01' : ['#af005f', '125'],
        \       'color02' : ['#5faf00', '70'],
        ...
        \       'search_fg' : ['#000000', '16'],
        \       'search_bg' : ['#00875f', '29'],
        \       'linenumber_fg' : ['#87d700', '240'],
        \       'linenumber_bg' : ['#112a2a', '234'],
